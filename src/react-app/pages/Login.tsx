...
export default function Login() {
  ...
  useEffect(() => {
    if (!isLoading && user) navigate('/profile', { replace: true });
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-6 py-24">
      <div className="max-w-md w-full bg-obsidian-800 p-10 rounded-2xl border border-gold/10 text-center">
        <img src={logo} alt="Premium Gems Lanka" className="h-12 w-auto mx-auto mb-8" />
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white text-black py-3.5 px-6 rounded-full hover:bg-gray-100 transition-colors font-medium"
        >
        ...
        <p className="text-xs text-ivory-muted mt-6">
