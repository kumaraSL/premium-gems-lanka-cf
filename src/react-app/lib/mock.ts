...
import heroBgV2 from '../assets/hero_bg_srilankan_v2.png';
...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    image_url: blueSapphire, images: [blueSapphire], stock: 1, weight: 1.5, shape: 'Oval', color: 'Royal Blue', treatment: 'Unheated', created_at: new Date().toISOString(), height: 7.2, width: 5.5, depth: 3.8
  },
  {
    ...
    image_url: padparadscha, images: [padparadscha], stock: 1, weight: 2.1, shape: 'Cushion', color: 'Peach-Orange', treatment: 'Unheated', created_at: new Date().toISOString(), height: 8.1, width: 6.4, depth: 4.2
  },
  {
    ...
    image_url: tealSapphire, images: [tealSapphire], stock: 1, weight: 1.8, shape: 'Round', color: 'Teal', treatment: 'Heated', created_at: new Date().toISOString(), height: 6.5, width: 6.5, depth: 4.0
  },
  {
    ...
    image_url: starRuby, images: [starRuby], stock: 1, weight: 3.5, shape: 'Cabochon', color: 'Red', treatment: 'Unheated', created_at: new Date().toISOString(), height: 9.0, width: 7.5, depth: 5.2
  }
];
